...
if not TOKEN:
    raise ValueError("توکن ربات را در Environment Variable با نام BOT_TOKEN تنظیم کنید!")
...
def calculate_boost_price(start_level, end_level):
    base_price = 15000  # کل از 1 تا 80
    total_levels = 80 - 1
...
async def button(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if query.data == "boost":
        ...
        keyboard = [
            [InlineKeyboardButton("تایید سفارش ✅", callback_data="boost_confirm")],
        ...
        price = round(gold_amount / 1000 * 50, 2)
